...
if __name__ == '__main__':
    IS_TRAINING = False
    seq1, res1, xs1 , full_length1  = read_batch(False)#get_batch("./OutCsv/amita/*.csv" , 0)  #read_batch(True)#
    print(" \n\n0 -------------------------------------------------------------------")
    print(len(seq1))
    print(len(res1))
    print(len(xs1))
    ...
    for i in range(2001):
        ...
        seq, res, xs , full_length = seq1, res1, xs1 , full_length1 #get_batch("./OutCsv/amita/*.csv" , i)
