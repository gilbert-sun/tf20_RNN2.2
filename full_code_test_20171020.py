...
class LSTMRNN(object):
    ...
    def add_output_layer(self):
        ...
        with tf.name_scope('Wx_plus_b'):
            ...
            tempPred1 = np.matmul(l_out_x, Ws_out) + bs_out

            print ("5--------------------------")
            #shape = (900, 1), (1580 ,4) ==> outsize
            print (self.pred1)
            print (np.shape(self.pred1))

            print ("5.5--------------------------")
            #shape = (900, 1), (1580 ,4) ==> outsize
            print (tempPred1)
            print (np.shape(tempPred1))
...
if __name__ == '__main__':
    ...
    seq1, res1, xs1 , full_length1,full_length2 ,Vdata_reshape1,Sdata_reshape1 ,Tdata_reshape1 ,label_reshape1  =  get_batch("./Exa_2017091x/*.csv" , 0)  #read_batch(True)#
    print(" \n\n0 -------------------------------------------------------------------")
    print(len(seq1))
    print(len(res1))
    print(len(xs1))
